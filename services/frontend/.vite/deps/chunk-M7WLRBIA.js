...
var require_utils = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/utils.js"(exports) {
    "use strict";
    ...
    function normaliseCookieScopeOrThrowError(cookieScope) {
      function helper(cookieScope2) {
        ...
        if (cookieScope2.startsWith(".")) {
          cookieScope2 = cookieScope2.substring(1);
        }
...
var require_utils2 = __commonJS({
  "node_modules/supertokens-website/lib/build/utils/index.js"(exports) {
    ...
    var normalisedURLDomain_1 = require_normalisedURLDomain3();
    var normalisedURLPath_1 = require_normalisedURLPath3();
    var windowHandler_1 = require_windowHandler();
...
// node_modules/supertokens-auth-react/lib/build/superTokens.js
var require_superTokens = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/superTokens.js"(exports) {
    "use strict";
    ...
    var Multitenancy = (
      /** @class */
      (function(_super) {
        utils.__extends(Multitenancy2, _super);
      ...
      return utils.__awaiter(this, void 0, void 0, function() {
        return utils.__generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 2, , 3]);
              return [4, utils.setFrontendCookie(CURRENT_LANGUAGE_COOKIE_NAME, language, cookieDomain)];
            case 1:
              _b.sent();
              return [3, 3];
            case 2:
      ...
      return utils.__awaiter(this, void 0, void 0, function() {
        return utils.__generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 2, , 3]);
              return [4, utils.getCookieValue(CURRENT_LANGUAGE_COOKIE_NAME)];
            case 1:
              return [2, _b.sent()];
            case 2:
              _b.sent();
    ...
    var SuperTokens = (
      /** @class */
      (function() {
        function SuperTokens2(config, plugins) {
          var _this = this;
            ...
            if (plugin.overrideMap !== void 0) {
              for (var _j = 0, _k = Object.keys(plugin.overrideMap); _j < _k.length; _j++) {
                ...
                this.componentOverrides[t] = utils.__assign(
                  ...
                  (_b = (_a = plugin.overrideMap[t]) === null || _a === void 0 ? void 0 : _a.components) !== null && _b !== void 0 ? _b : {}
                );
              }
            }
          ...
          var _loop_1 = function(pluginIndex2) {
            var _l;
            var pluginInit = plugins[pluginIndex2].init;
            if (pluginInit && !this_1.pluginList[pluginIndex2].initialized) {
            ...
            var pluginRouteHandlers = plugins[pluginIndex2].routeHandlers;
          ...
          this.languageTranslations = {
            ...
            currentLanguageCookieScope: translationConfig.currentLanguageCookieScope !== void 0 ? utils.normaliseCookieScopeOrThrowError(translationConfig.currentLanguageCookieScope) : utils.getDefaultCookieScope(),
        ...
        SuperTokens2.init = function(config) {
          ...
          if ((_b = config.experimental) === null || _b === void 0 ? void 0 : _b.plugins) {
            for (var _i = 0, _c = config.experimental.plugins; _i < _c.length; _i++) {
              ...
              if (plugin.compatibleAuthReactSDKVersions) {
                ...
                if (!versionCheck) {
                  throw new Error(
                    "Incompatible SDK version for plugin ".concat(plugin.id, '. Version "').concat(utils.package_version, '" not found in compatible versions: ').concat(JSON.stringify(plugin.compatibleAuthReactSDKVersions))
                  );
                }
              }
              if (plugin.dependencies) {
          ...
          SuperTokensWebJS__default.default.init(
            utils.__assign(utils.__assign({}, config), {
              ...
              experimental: {
                plugins: finalPluginList.map(function(plugin2) {
                  return {
                    id: plugin2.id,
                    overrideMap: plugin2.overrideMap
                  };
                })
              }
            })
          );
          SuperTokens2.instance = new SuperTokens2(
        ...
        SuperTokens2.getInstance = function() {
          return SuperTokens2.instance;
        };
        SuperTokens2.getInstanceOrThrow = function() {
          if (SuperTokens2.instance === void 0) {
                    ...
                    if (context.tenantIdFromQueryParams) {
                      return [
                        ...
                        utils.appendQueryParamsToURL(
                          basePath,
                          (_b = {}, _b[utils.TENANT_ID_QUERY_PARAM] = context.tenantIdFromQueryParams, _b)
                        )
                      ];
                    }
                    return [2, basePath];
    ...
    var createGenericComponentsOverrideContext = function(v, key) {
      ...
      var useComponentsOverrideContext = function() {
        ...
        return utils.__assign(
          utils.__assign(
            {},
            (_a = superTokens.SuperTokens.getInstance()) === null || _a === void 0 ? void 0 : _a.componentOverrides[key]
          ),
          contextValue
        );
      };
      var Provider = function(_a) {
        ...
        return jsxRuntime.jsx(genericContext.Provider, utils.__assign({ value: components }, { children }));
      };
...
var require_recipeModule_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/recipeModule-shared.js"(exports) {
    ...
    var RecipeModule = (
      /** @class */
      (function(_super) {
        utils.__extends(RecipeModule2, _super);
...
var require_oauth2provider_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/oauth2provider-shared.js"(exports) {
    ...
    var OAuth2Provider = (
      /** @class */
      (function(_super) {
        utils.__extends(OAuth2Provider2, _super);
...
var require_multifactorauth_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/multifactorauth-shared.js"(exports) {
    ...
    var Session = (
      /** @class */
      (function(_super) {
        utils.__extends(Session2, _super);
              ...
              return utils.__generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 6:
                    ...
                    return [4, utils.getLocalStorage("supertokens-success-redirection-context")];
                  case 7:
                ...
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    Array.from(this.eventListeners).forEach(function(listener) {
                      return listener(utils.__assign({ sessionContext }, event));
                    });
                    return [
                      2
                      /*return*/
...
export {
  ...
  require_utils7 as require_utils5,
  require_superTokens,
...
//# sourceMappingURL=chunk-M7WLRBIA.js.map
