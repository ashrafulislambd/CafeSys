...
var require_session_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/session-shared.js"(exports) {
    ...
    var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(void 0, types.Session.RECIPE_ID);
    var useContext = _a[0];
    var Provider = _a[1];
...
var require_session2 = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/session.js"(exports) {
    ...
    var BooleanClaim = (
      /** @class */
      (function(_super) {
        utils.__extends(BooleanClaim2, _super);
    ...
    var PrimitiveArrayClaim = (
      /** @class */
      (function(_super) {
        utils.__extends(PrimitiveArrayClaim2, _super);
    ...
    var PrimitiveClaim = (
      /** @class */
      (function(_super) {
        utils.__extends(PrimitiveClaim2, _super);
...
//# sourceMappingURL=chunk-34ELLWBJ.js.map
